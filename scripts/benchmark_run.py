...
from cognitive_os.benchmarks.routing_adapter import routing_benchmark_case
...
from cognitive_os.benchmarks.weakness_adapter import weakness_benchmark_case
...
async def _run(manifest_path: Path, output: Path, seed: int, mode: str) -> int:
    ...
    elif mode == "domain-pilot":
        executor = domain_benchmark_case
    elif mode == "context-replay":
        executor = context_benchmark_case
    elif mode == "skill-replay":
        executor = skill_benchmark_case
    elif mode == "strategy-replay":
        executor = strategy_benchmark_case
    elif mode == "experience-replay":
        executor = experience_benchmark_case
    elif mode == "routing-replay":
        executor = routing_benchmark_case
    elif mode == "weakness-replay":
    ...
    elif mode == "provider-replay":
        from cognitive_os.benchmarks.provider_adapter import provider_benchmark_case

        executor = provider_benchmark_case
