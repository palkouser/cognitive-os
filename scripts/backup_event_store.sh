...
(
    ...
    routing_history_sha256,
    weakness_counts_json,
    weakness_history_sha256,
    proposal_counts_json,
    proposal_history_sha256,
    change_counts_json,
    change_history_sha256,
    domain_counts_json,
    domain_history_sha256,
    learned_counts_json,
    learned_history_sha256,
    provider_output_counts_json,
    provider_output_history_sha256,
) = sys.argv[1:]
digest = lambda path: hashlib.sha256(Path(path).read_bytes()).hexdigest()
data = {
    "created_at": datetime.now(UTC).isoformat(),
    "git_commit": subprocess.check_output(["git", "rev-parse", "HEAD"], text=True).strip(),
    "sprint_parent_baseline": "sprint-18-baseline",
    "sprint19_inventory_sha256": "bf48c294063b193c7d3414f84a4688714a9d819c5777bd65916d6b80cff2e3ff",  # pragma: allowlist secret
    ...
    "weakness_counts": json.loads(weakness_counts_json),
    "weakness_history_sha256": weakness_history_sha256,
    "proposal_counts": json.loads(proposal_counts_json),
    "proposal_history_sha256": proposal_history_sha256,
    "change_counts": json.loads(change_counts_json),
    "change_history_sha256": change_history_sha256,
    "domain_counts": json.loads(domain_counts_json),
    "domain_history_sha256": domain_history_sha256,
    # Counts and a content-hash roll-up, never artifact bytes: learned lineage
    # references the artifact archive this same backup already carries.
    "learned_counts": json.loads(learned_counts_json),
    "learned_history_sha256": learned_history_sha256,
    "provider_output_counts": json.loads(provider_output_counts_json),
    "provider_output_history_sha256": provider_output_history_sha256,
}
