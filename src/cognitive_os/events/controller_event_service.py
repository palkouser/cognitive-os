"""Expected-version protected controller event persistence."""
...
class ControllerEventService:
    def __init__(self, event_store: EventStorePort) -> None:
        ...
        self._actor = ActorRef(actor_type=ActorType.SYSTEM, actor_id="cognitive-controller")
    ...
    async def append(
        ...
        *,
        ...
        envelope = create_event_envelope(
            ...
            actor=self._actor,
            source_component="cognitive-controller",
