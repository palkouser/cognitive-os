...
| 29 | ⏳ **pending** | the protected merge of #229, its exact-head post-merge CI, the annotated tag `sprint-21-learning-baseline` and the remote read of all three |
