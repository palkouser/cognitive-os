...
temporal intervals, contradiction history, and Wiki lineage in an isolated test database. Preserve
the source database and investigate any health warning rather than repairing history destructively.
